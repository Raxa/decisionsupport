...
public class dayPhoneNum implements Rule
{
			...
			Map<String, Object> parameters) throws LogicException
	{
		...
		PersonAttribute patientAttribute = patient.getAttribute("Telephone Number");
		if(patientAttribute != null)
		{
			return new Result(patientAttribute.getValue());
		}
